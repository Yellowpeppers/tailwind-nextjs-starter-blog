...
export const dictionary = {
  en: {
    ...
    home: {
      ...
      trust: {
        ...
        privacy: {
          title: 'Privacy First',
          desc: '100% client-side. Your results never leave your browser.',
        },
        actionable: {
          title: 'Tailored Recommendations',
          desc: 'Get matched with tools (like Quiet Fidgets) based on your score.',
        },
      },
      resourceHub: {
        tagline: 'Explore NeuroHacks',
        title: 'Resource Hub',
        desc: 'Choose your path—jump straight into the ADHD assessment, shop trusted buying guides, or dive into research-backed topics.',
        focusLabDesc:
          'Your personal mission control. White noise, task breaker, scratchpad, dopamine menu, and timers in one distraction-free space.',
        guidesDesc: 'Honest reviews of fidgets, apps, and gear.',
        enterFocusLab: 'Enter Focus Lab',
      },
      faq: {
        tagline: 'FAQs',
        title: 'ADHD Test Online: Frequently Asked Questions',
        ...
        items: [
          {
            q: 'Is this ADHD test online accurate?',
            a: "This tool uses the ASRS v1.1, which is a scientifically validated screening checklist developed by the World Health Organization. While no ADHD test online can replace a doctor's diagnosis, it is highly reliable for identifying symptom patterns.",
          },
          {
            q: 'Is this really a free ADHD test?',
            a: 'Yes. Unlike other sites that hide results behind a paywall, NeuroHacks Lab provides a completely free ADHD test online with instant results.',
          },
          {
            q: 'Do I need to provide my email?',
            a: 'No. We believe in privacy. You can take this adult ADHD screening directly in your browser without signing up.',
          },
          {
            q: 'What should I do after taking the test?',
            a: 'If your score indicates high symptoms, we recommend consulting a specialist. You can also explore our Focus Lab and Guides to manage your focus immediately.',
          },
        ],
      },
      blog: {
        ...
        desc: 'Deep dives into quiet sensory gear, focus rituals, and ADHD-friendly planning systems to pair with your ASRS v1.1 results.',
  ...
  cn: {
    ...
    home: {
      ...
      heroHeadline: '免费在线成人 ADHD 测试 & 生产力工具箱',
      heroSubheadline:
        '是 ADHD 还是现代生活的压力？参加世界卫生组织 (WHO) ASRS v1.1 自测。无需邮箱——只有清晰、科学和神经多样性友好的工具。',
      startAssessment: '开始免费评估 →',
      privacyNote: '2分钟 ASRS v1.1 · 100% 隐私保护',
      trust: {
        scientific: { title: '科学严谨', desc: '基于 WHO 开发的 ASRS v1.1 症状清单。' },
        privacy: { title: '隐私优先', desc: '100% 客户端运行。您的结果永远不会离开浏览器。' },
        actionable: { title: '量身定制的建议', desc: '根据您的得分匹配工具（如静音解压玩具）。' },
      },
      resourceHub: {
        tagline: '探索 NeuroHacks',
        title: '资源中心',
        desc: '选择您的路径——直接进入 ADHD 评估，购买值得信赖的指南，或深入研究支持的主题。',
        focusLabDesc:
          '您的个人任务控制中心。白噪音、任务拆解器、草稿纸、多巴胺菜单和计时器，尽在一个无干扰的空间。',
        guidesDesc: '对解压玩具、App 和装备的深度评测。',
        enterFocusLab: '进入专注实验室',
      },
      faq: {
        tagline: '常见问题',
        title: '在线 ADHD 测试：常见问题解答',
        desc: '了解这个成人 ADHD 自测是如何工作的，为什么它是免费的，以及得到分数后该做什么。',
        items: [
          {
            q: '这个在线 ADHD 测试准确吗？',
            a: '该工具使用 ASRS v1.1，这是世界卫生组织开发的经过科学验证的筛查清单。虽然没有任何在线 ADHD 测试可以取代医生的诊断，但它在识别症状模式方面非常可靠。',
          },
          {
            q: '这真的是免费的 ADHD 测试吗？',
            a: '是的。与其他将结果隐藏在付费墙后的网站不同，NeuroHacks 实验室提供完全免费的在线 ADHD 测试，并即时出结果。',
          },
          {
            q: '我需要提供邮箱吗？',
            a: '不需要。我们重视隐私。您可以直接在浏览器中进行此成人 ADHD 筛查，无需注册。',
          },
          {
            q: '测试后我该做什么？',
            a: '如果您的得分显示症状明显，我们建议咨询专家。您也可以探索我们的专注实验室和指南来立即管理您的注意力。',
          },
        ],
      },
      blog: {
        tagline: 'ADHD 必备工具',
        title: '深度评测',
        desc: '深入探讨静音感官装备、专注仪式和 ADHD 友好的计划系统，配合您的 ASRS v1.1 结果使用。',
        noPosts: '暂无文章。',
        readMore: '阅读更多',
        allPosts: '所有文章',
      },
