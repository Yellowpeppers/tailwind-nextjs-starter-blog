  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex h-[80vh] w-full max-w-4xl flex-col rounded-3xl bg-white shadow-2xl dark:bg-gray-900"
        ...
        <div className="scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-gray-800 flex-1 overflow-y-auto p-6">
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="flex flex-col gap-6">
              ...
              {/* Weekly Chart */}
              <div className="flex-1 rounded-2xl border border-gray-100 p-6 dark:border-gray-800">
