...
import { FocusedTaskState } from '@/components/focus-lab/types'
...
export const TimerCard = memo(function TimerCard({
  ...
  const { state: timerState, actions: timerActions } = useFocusTimer({
    isFlipped,
    onTimerComplete: onTimerCompleteAction,
    onSessionLogged: onSessionLoggedAction,
    focusedTask,
  })
