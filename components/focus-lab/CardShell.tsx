...
export function CardShell({
  ...
  return (
    ...
    >
      {headerHidden && (
        <div className="focuslab-drag-handle absolute inset-x-0 top-0 z-20 h-4 !cursor-default" />
      )}
      ...
      <div
        className={`focuslab-drag-handle flex items-center justify-between gap-2 ${headerHidden ? 'h-0 min-h-0' : 'h-7'} min-w-0 !cursor-default`}
