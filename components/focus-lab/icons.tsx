...
export const SmileCircleIcon = ({ className }: { className?: string }) => (
...
export const HandPalmIcon = ({ className }: { className?: string }) => (
  <span className={`icon-[solar--hand-shake-linear] ${className}`} />
)
...
export const ArrowLaunchIcon = ({ className }: { className?: string }) => (
