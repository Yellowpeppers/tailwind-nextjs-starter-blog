  ...
  return (
    <div className="flex flex-col items-start justify-start md:mt-24 md:flex-row md:items-center md:justify-center md:space-x-6">
      ...
      <div className="max-w-md">
        <p className="mb-4 text-xl leading-normal font-bold md:text-2xl">{t.notFound.title}</p>
        <p className="mb-8 text-gray-600 dark:text-gray-300">{t.notFound.description}</p>
        <Link
          href="/"
