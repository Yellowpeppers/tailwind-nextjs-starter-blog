...
const getResultBucket = (score: number, t: Dictionary) => {
...
export default function TestExperience() {
  ...
  return (
    ...
    >
      <div className="shadow-primary-500/5 rounded-3xl border border-gray-200 bg-white/80 p-8 shadow-xl backdrop-blur dark:border-gray-700 dark:bg-gray-900/80">
        {!quizStarted ? (
          <IntroView />
        ) : isAnalyzing ? (
          <AnalyzingView />
          ...
          <div className="mt-8 space-y-8">
            ...
            <div className="space-y-4 text-center">
              ...
              <div className="mt-6 flex w-full justify-center border-t border-gray-100 pt-6 dark:border-gray-700">
                <Link
